...
int main(){
   ...
   BigInteger my1 = BigInteger("+123456677");
   cout<<"my1: " << my1 << endl;

   cout<<"sign of my1: " << my1.sign() << endl;

   my1.negate();
   cout<<"sign of my1 after negate: " << my1.sign() << endl;

   my1.makeZero();
   cout<<"my1 after makeZero: " << my1 << endl;
   cout<<"sign of my1 after makeZero: " << my1.sign() << endl;
